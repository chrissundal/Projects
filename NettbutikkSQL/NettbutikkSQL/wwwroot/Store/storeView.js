...
function createCartItems() {
    ...
    for (let cartIndex = 0; cartIndex < Model.cart.length; cartIndex++) {
        let checkSale = Model.cart[cartIndex].isOnSale ? `style="color: red"` : '';
        html += `
        <div class="innerCart">
            <div>Antall: ${Model.cart[cartIndex].stock}</div>
